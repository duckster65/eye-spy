...
import 'package:eye_spy/pages/home.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:eye_spy/pages/login.dart';
                      ...
                      children: [
                              ...
                              child: Column(
                                ...
                                children: [
                                  FittedBox(
                                    ...
                                    child: AutoSizeText(
                                        "Welcome to EyeSpy!",
                                        style: GoogleFonts.montserrat(fontWeight: FontWeight.bold, fontSize: 40),
                                    ),
                                  ),
                                  Text(
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              border: Border.all(width: 2.0, color: Color.fromRGBO(80, 100, 172, 1)),
                              boxShadow: [
                                BoxShadow(
